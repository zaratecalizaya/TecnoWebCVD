  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="imagenes/minilogobago.png" alt="Bago Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Autorepuesto</span>
    </a>
      ...
      <nav class="mt-2 ">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./nota_compra.php" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>NOTA DE COMPRA </p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./detalle_compra.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./detalle_venta.php" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <div class="card card-primary">
              ...
              <form role="form" enctype="multipart/form-data" method="post"  >
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputAño">Año</label>
                  ...
                  <div class="form-group">
                    <label for="InputUsuario">Foto </label>

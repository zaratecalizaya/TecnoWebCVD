...
<body class="hold-transition login-page hero-image">
  <div class="login-box">
    <div class="login-logo">
      <img src="imagenes/pixlr-bg-result.png" height="150" width="350" alt="Logo Image">
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg">Inicia con tu cuenta para seguir</p>
        ...
        <form role="form" method="post">
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <!-- /.col -->
              <div class="col-4">
                <button type="submit" name="IniciarSesion" class="btn btn-primary btn-block">Iniciar Sesión</button>

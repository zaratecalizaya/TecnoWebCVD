...
<div class="content-wrapper">
  ...
  <section class="content hero-image" >
    <div class="container-fluid" >
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php 
                  ...
                  while (count($list)>0){
                    ...
                    echo "<tr>";
                    $Did_compra = array_shift($Nivel);
                    echo "<td>".$Did_compra."</td>";
                    $Dfecha_compra = array_shift($Nivel);
                    echo "<td>".$Dfecha_compra."</td>";
                    $Dprecio_total = array_shift($Nivel);
                    echo "<td>".$Dprecio_total."</td>";
                    $Did_proveedor = array_shift($Nivel);
                    echo "<td>".$Did_proveedor."</td>";
                    $Did_empleado = array_shift($Nivel);
                    echo "<td>".$Did_empleado."</td>";
                   
                  
                    echo '<td>
                            <button class="btn" onclick="saveData('.$Did_compra.',\''.$Dfecha_compra.'\',\''.$Dprecio_total.'\',\''.$Did_proveedor.'\',\''.$Did_empleado.'\')"><i class="fas fa-edit"></i> Editar</button>
      ...
      <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title"><label id="TituloUser">Agregar Nota Compra</label> </h3> 
              <button id="nuevoNivel" class="btn float-right" onclick="newUser()" > <i class="fas fa-user-plus"></i> Nueva Nota Compra</button>
            ...
            <form role="form" enctype="multipart/form-data"  method="post"   >
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputId">ID COMPRA</label>
                  <input type="hidden"  class="form-control"  id="id_compra" name="id_compra" placeholder="ID_COMPRA" value="0" readonly="true">
                </div>
                <div class="form-group">
                  <label for="exampleInputNombre">FECHA  Compra</label>
                  <input type="text" class="form-control" id="fecha_compra" name="fecha_compra" placeholder="Ingrese fecha compra">
                </div>
                <div class="form-group">
                  <label for="InputUsuario">PRECIO TOTAL</label>
                  <input type="text" class="form-control" id="precio_total" name="precio_total" placeholder="Ingrese el precio_total">
                </div>
                 
                 
                <div class="form-group">
                  <label for="InputUsuario">PROVEEDOR</label>
                  <input type="text" class="form-control" id="id_proveedor" name="id_proveedor" placeholder="Ingrese id_cliente">
                </div>

                <div class="form-group">
                  <label for="InputUsuario">EMPLEADO</label>
                  <input type="text" class="form-control" id="id_empeado" name="id_empleado" placeholder="Ingrese id_empleado">
                </div>

  ...
  <div class="content-wrapper">
    ...
    <div class="content-header hero-image" >
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-white">Lista de grupo de comportamientos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card card-primary">
              <div class="card-header" >
                <h3 class="card-title">Lista de grupo de comportamientos</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    $clogros = new ControladorLogro();
                    $list=  $clogros -> ctrListarGrupoComportamientos(1,1000);
